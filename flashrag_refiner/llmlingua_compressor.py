...
class PromptCompressor:
    ...
    def __init__(
        ...
        if chat_tokenizer == "openai":
            self.oai_tokenizer = tiktoken.encoding_for_model("gpt-3.5-turbo")
        elif chat_tokenizer == "llama":
            tokenizer_path = "../../huggingface/Meta-Llama-3.1-70B-Instruct/"
            self.oai_tokenizer = AutoTokenizer.from_pretrained(tokenizer_path)
        else:
            raise NotImplementedError(f"chat_tokenizer {chat_tokenizer} not supported")
